...
import com.tutorial.authorizationserver.enums.AuthenticationMethod;
import com.tutorial.authorizationserver.enums.Methods;
        ...
        return context -> {
            ...
            if (context.getTokenType().getValue().equals("access_token")) {
                ...
                context.getClaims().claim("roles", roles)
                        ...
                        .claim(String.format(Methods.AUTHENTICATION_METHOD.name()).toLowerCase(), AuthenticationMethod.OAuth2);
            }
        };
    }
